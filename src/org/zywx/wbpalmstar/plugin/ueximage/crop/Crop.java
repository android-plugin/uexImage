...
public class Crop {
    ...
    interface Extra {
        ...
        String MAX_Y = "max_y";
        String ERROR = "error";
        String QUALITY = "cropQuality";
        String USE_PNG = "cropUsePng";
    }
    ...
    public static Crop of(Uri source, Uri destination, double cropQuality, boolean cropUsePng) {
        return new Crop(source, destination, cropQuality, cropUsePng);
    }
    ...
    private Crop(Uri source, Uri destination, double cropQuality, boolean cropUsePng) {
        cropIntent = new Intent();
        cropIntent.setData(source);
        cropIntent.putExtra(MediaStore.EXTRA_OUTPUT, destination);
        cropIntent.putExtra(Extra.QUALITY, cropQuality);
        cropIntent.putExtra(Extra.USE_PNG, cropUsePng);
    }
    ...
    private static void showImagePickerError(Context context) {
        android.util.Log.i("uexImage", "Crop: pickImage error");
    }
